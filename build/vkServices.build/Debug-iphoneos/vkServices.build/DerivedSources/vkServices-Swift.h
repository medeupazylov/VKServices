...
#ifndef VKSERVICES_SWIFT_H
#define VKSERVICES_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="vkServices",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC10vkServices11AppDelegate")
...
SWIFT_CLASS("_TtC10vkServices13SceneDelegate")
...
SWIFT_CLASS("_TtC10vkServices20ServiceTableViewCell")
...
SWIFT_CLASS("_TtC10vkServices21ServiceViewController")
...
@interface ServiceViewController (SWIFT_EXTENSION(vkServices)) <UITableViewDataSource>
- (UITableViewCell * _Nonnull)tableView:(UITableView * _Nonnull)tableView cellForRowAtIndexPath:(NSIndexPath * _Nonnull)indexPath SWIFT_WARN_UNUSED_RESULT;
- (void)tableView:(UITableView * _Nonnull)tableView didSelectRowAtIndexPath:(NSIndexPath * _Nonnull)indexPath;
@end


@interface ServiceViewController (SWIFT_EXTENSION(vkServices)) <UITableViewDelegate>
